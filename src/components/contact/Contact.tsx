...
const Contact: React.FC = () => {
  ...
  return (
    <section className={`${styles.contact} section parallax-section`} id="contact">
        ...
        <div className={styles.contactContent}>
          ...
          <div className={styles.contactInfo}>
            <div className={styles.contactCard}>
              ...
              <a className={styles.contactButton} href="mailto:voronin.yevhenii@gmail.com">
                Write me <i className={`${styles.contactButtonIcon} bx bx-rigth-arrow-alt`} />
              </a>
            </div>
            <div className={styles.contactCard}>
              ...
              <a className={styles.contactButton} rel="noreferrer" target="_blank" href="https://t.me/voroninee">
                Write me <i className={`${styles.contactButtonIcon} bx bx-rigth-arrow-alt`} />
              </a>
            </div>
            <div className={styles.contactCard}>
              ...
              <a className={styles.contactButton} rel="noreferrer" target="_blank" href="https://www.linkedin.com/in/yevhenii-voronin-kyiv/">
                Follow me <i className={`${styles.contactButtonIcon} bx bx-rigth-arrow-alt`} />
              </a>
            </div>
          </div>
        </div>
        <div className={styles.contactContent}>
          ...
          <form className={styles.contactForm} ref={form} onSubmit={sendEmail}>
            ...
            <div className={styles.contactFormDiv}>
              ...
              />
              {!checkValidEmail && <span className={styles.incorrectNameValue}>Invalid email address entered</span>}
            </div>
