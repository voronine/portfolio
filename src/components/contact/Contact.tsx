          ...
          <div className={styles.contactInfo}>
            ...
            <div className={styles.contactCard}>
              ...
              <a
                ...
                rel="noreferrer"
                target="_blank"
                href="https://www.linkedin.com/in/yevhenii-voronin-kyiv/"
              >
        ...
        <div className={styles.contactContent}>
          ...
          <form className={styles.contactForm} ref={form} onSubmit={sendEmail}>
            <div className={styles.contactFormDiv}>
              ...
              />
              {!checkValidName && (
                <span className={styles.incorrectNameValue}>Only letters available</span>
              )}
            </div>
            <div className={styles.contactFormDiv}>
              <label htmlFor="mail" className={styles.contactFormTag}>
                Mail*
              </label>
              <input
                id="mail"
              ...
              />
              {!checkValidEmail && (
                <span className={styles.incorrectNameValue}>
